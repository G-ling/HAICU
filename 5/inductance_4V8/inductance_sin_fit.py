...
v = lambda x: sin(x,90,216700,-np.pi/1.3)
i = lambda x: sin(x,170,216700,-np.pi/1.5)

#fit

params_v, params_covariance = optimize.curve_fit(sin, vread_t["in s"], vread_t["C2 in V"], p0=[60,216700,-np.pi/1.5])
params_i, params_covariance = optimize.curve_fit(sin, iread_t["in s"], iread_t["C3 in V"], p0=[90,216700,-np.pi/1.5])
v_fit = lambda x: sin(x,params_v[0],params_v[1],params_v[2])
i_fit = lambda x: sin(x,params_i[0],params_i[1],params_i[2])
